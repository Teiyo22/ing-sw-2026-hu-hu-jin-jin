...
public class Fonts {
    public static final Font large  = new Font(Font.SANS_SERIF, Font.PLAIN, 40);
    public static final Font medium = new Font(Font.SANS_SERIF, Font.PLAIN, 30);
    public static final Font small  = new Font(Font.SANS_SERIF, Font.PLAIN, 20);
    public static final Font tiny  = new Font(Font.SANS_SERIF, Font.PLAIN, 15);
